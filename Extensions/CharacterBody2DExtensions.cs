...
public static class CharacterBody2DExtensions
{
    ...
    public static void ApplyKnockback(this CharacterBody2D controller, Vector2 knockbackPoint, float force)
    {
        Vector2 dir = knockbackPoint.DirectionTo(controller.GlobalPosition);
